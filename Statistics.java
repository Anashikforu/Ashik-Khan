...
PreparedStatement pst;
    ...
    public void jTable1(){
        try{
         String sql="select Book_ID,Name,Price,Student_ID,SName,Department,Date_Of_Issue from IssueBook";
    ...
    public void jTable2(){
       try{
         String sql="select Student_ID,Name,Department,Book_ID,BName,ReturnDate from ReturnBook";
         pst=conn.prepareStatement(sql);
         rs=pst.executeQuery();
    ...
    public void jTable3(){
        String sql="select Name,Username,Password,Sec_Q,Answer from Account";
        try{
          pst=conn.prepareStatement(sql);
          rs=pst.executeQuery();
