...
PreparedStatement pst;
    ...
    public void ReturnUpdate(){
        String sql="insert into ReturnBook(Student_ID,Name,FName,Department,Year,Semester,Book_ID,BName,Edition,Publisher,Price,Pages,IssueDate,ReturnDate) values (?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
        try{
          pst=conn.prepareStatement(sql);
          pst.setString(1, jTextField4.getText());
